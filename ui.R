...
shinyUI(fluidPage(
  ...
  navlistPanel(
                               ...
                               tabsetPanel(id = "tabs",
                                 ...
                                 tabPanel("Rank IPL Players",
                                          ...
                                          sidebarPanel(
                                            ...
                                            ')),
                                            sliderInput("years", "Since year",min = (helper(IPLTeamNames,"./ipl/iplBattingBowlingDetails")[[1]]), max = (helper(IPLTeamNames,"./ipl/iplBattingBowlingDetails")[[2]]), value = 2020, step = 1),
                                            ...
                                            #selectInput('runsOverSR', 'Choose Runs vs SR', runsVsSR),
                                            uiOutput("Mode")
    ...
    tabPanel("Intl. T20 (women)",navbarPage("GooglyPlusPlus - International T20 (women)",
                                         ...
                                         # Rank T20 Women  tab
                                         tabPanel("Rank Intl. T20 Women",

                                                  h4('Rank Intl. T20  Women performances'),

                                                  sidebarPanel(
                                                    selectInput('rankFuncT20W', 'Select function', rankT20WPlayerFuncs),
                                                    sliderInput("minMatchesT20W", "Minimum Matches:",
                                                                min = 10, max = 50,
                                                                value = 35),
    ...
    tabPanel("PSL T20",navbarPage("GooglyPlusPlus - Pakistan Super League",
                                  ...
                                  # Rank PSL PlayersL tab
                                  tabPanel("Rank PSL Players",

                                           h4('Rank PSL player performances'),

                                           sidebarPanel(
                                             selectInput('rankFuncPSL', 'Select function', rankPSLPlayerFuncs),
                                             sliderInput("minMatchesPSL", "Minimum Matches:",
                                                         min = 10, max = 30,
                                                         value = 25),
    ...
    tabPanel("WBBL T20",navbarPage("GooglyPlusPlus - Women's Big Bash League",
                                  ...
                                  tabPanel("Rank WBB Players",

                                           h4('Rank WBB player performances'),

                                           sidebarPanel(
                                             selectInput('rankFuncWBB', 'Select function', rankWBBPlayerFuncs),
                                             sliderInput("minMatchesWBB", "Minimum Matches:",
                                                         min = 10, max = 23,
                                                         value = 18),
    ...
    tabPanel("About GooglyPlusPlus 2021",h3("GooglyPlusPlus 2021 - Analyzing ODI,T20 Players, teams and matches with plots and tables"),
             ...
             p("This data includes the all the latest data including IPL 2020"),
